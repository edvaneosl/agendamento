...
?>
    ...
    <section class="agenda bloco scrollspy" id="resposta">
        	...
        	<div class="col s12">
		      <div class="card grey lighten-2" style="padding-bottom: 100px;">
		        ...
		        <div class="card-content white-text">
		        	...
		        	<a href="reservas.php" class="btn btn-small halfway-fab waves-effect waves-light blue">Realizar outra reserva</a>
		        </div>
