...
<!-- adicionar -->
	    ...
	    <section class="adicionar bloco scrollspy" id="adicionar">
	      <div class="container">
	      ...
	      <form action="../reservas/create.php" method="POST" id="formAdd" name="formAdd">
	      	<div class="row form">
          ...
          <div class="row center">
					<button style="color:darkblue" href="#reservas" class=" btn btn-primary blue_logo center" type="submit" name="btn-cadastrar">Cadastrar reserva</button>
					<a style="" href="agenda.php" class=" btn btn-primary orange center" type="" name="">Consultar horários disponíveis</a>
					</div>
